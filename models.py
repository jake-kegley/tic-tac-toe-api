...
class Game(ndb.Model):
	...
	attempts_remaining = ndb.IntegerProperty(required=True, default=False)
	...
	def to_form(self, message):
		"""Returns a GameForm representation fo the Game"""
		form = GameForm()
...
class GameForm(messages.Message):
	"""GameForm for outbound game state info"""
...
class MakeMoveForm(messages.Message):
	...
	messages = messages.StringField(1, required=True)
...
class ScoreForms(messages.Message):
	...
	items = messages.StringField(1, required=True)
